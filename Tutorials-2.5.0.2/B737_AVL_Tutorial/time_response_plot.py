...
def plot_modal_response_3d(
    ...
    """
    Plot a symmetric 3D modal time response about y=0 and z=0 planes.

    Parameters
    ----------
    eigenvalue : complex
        Eigenvalue sigma + i*omega
    A : float
        Initial amplitude
    phase : float
        Initial phase [rad]
...
if __name__ == '__main__':
    ...
    txt_file = r"C:/Users/nmb48/suave_dynamic_stability_outputs_6_0.txt"
