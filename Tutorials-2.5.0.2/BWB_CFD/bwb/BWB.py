...
def base_analysis(vehicle):
    ...
    ###
    # aerodynamics.process.compute.lift.inviscid.training_file              = 'base_data.txt'  # NILS: commented, othwerwise surrogate model based on precomputed CFD results will be used
    ###
    ...
    aerodynamics.process.compute.lift.inviscid.training.Mach               = np.array([.85])  # NILS
    aerodynamics.process.compute.lift.inviscid.training.angle_of_attack    = np.array([0.]) * Units.deg  # NILS
