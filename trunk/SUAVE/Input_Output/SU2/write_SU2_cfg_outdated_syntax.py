...
-------------------------------------------------------------------------
Line 115 CONV_CRITERIA: invalid option name. Check current SU2 options in config_template.cfg.
Did you mean INCREMENTAL_CRITERIA?
Line 159 WRT_SOL_FREQ: invalid option name. Check current SU2 options in config_template.cfg.
Did you mean BC_EVAL_FREQ?
Line 161 WRT_CON_FREQ: invalid option name. Check current SU2 options in config_template.cfg.
Did you mean BC_EVAL_FREQ?

and has been superseded with write_SU2_cfg.py whose syntax matches that
used by SU2 v6.0.0.
"""
