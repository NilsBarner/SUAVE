...
def write_vsp_mesh(geometry,tag,half_mesh_flag,growth_ratio,growth_limiting_flag,cfd_far_field_flag):  # NILS: added last argument on 21.03.2026 to create base.stl mesh without CFD far field bounding box
    ...
    import sys
    # sys.exit("NILS: stop here.")  # NILS: 26.03.2026 - this is to allow testing of the mesh generation without running the CFD analysis, which can be time-consuming. Remove or comment out this line to run the full analysis.
