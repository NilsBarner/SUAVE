        ...
        for case in avl_object.current_status.cases:
            ...
            if trim_aircraft == False: # this flag sets up a trim analysis if one is declared by the boolean "trim_aircraft"
                ...
                if case.stability_and_control.number_control_surfaces != 0 :
                    ...
                    print('<><><>')
                    print('case.stability_and_control.control_surface_names,case.stability_and_control.control_surface_functions =', case.stability_and_control.control_surface_names,case.stability_and_control.control_surface_functions)
                    print('<><><>')
            ...
            print()
            print('controls_text =', controls_text)
            print()
...
def make_controls_case_text(cs_names, cs_functions):
    ...
    for idx in range(len(cs_names)):
        ...
        # # =============================================================================
        # if not cs_function in ['flap', 'aileron', 'elevator', 'rudder']:  # added by NILS
        #     continue
        # # =============================================================================
        print('cs_function =', cs_function)
        ...
        # =============================================================================
        if (cs_function == 'flap' or cs_function == 'slat'):         # if control surface function is 'flap', specify to AVL that it is a flap
        # =============================================================================
            # ctrl_name = "{:<13}".format(ctrl_tag)
            # =============================================================================
            ctrl_name = "{:<13}".format('flap')
            # =============================================================================
            variable  = 'flap        '
