...
cx(x,y,z) = y*z - z*y
cy(x,y,z) = z*(x-xb) - (x-xa)*z
cz(x,y,z) = (x-xa)*y - y*(x-xb)
...
c(x,y,z,eps) = sqrt(ab(x,y,z) + eps**2)
d(x,y,z,eps) = cx(x,y,z)**2 + cy(x,y,z)**2 + cz(x,y,z)**2 + (xb-xa)**2*eps**2

A(x,y,z,eps) = (b(x,y,z,eps) - csq(x,y,z,eps)/a(x,y,z,eps)) / d(x,y,z,eps)
B(x,y,z,eps) = (a(x,y,z,eps) - csq(x,y,z,eps)/b(x,y,z,eps)) / d(x,y,z,eps)

wsx(x,y,z,eps) = \
(  (x-xa)*(b(x,y,z,eps) - (ab(x,y,z)+eps**2)/sqrt(aa(x,y,z)+eps**2)) \
 + (x-xb)*(sqrt(aa(x,y,z)+eps**2) - (ab(x,y,z)+eps**2)/sqrt(bb(x,y,z)+eps**2)) \
) / d(x,y,z,eps)
wsy(x,y,z,eps) = \
(   y    *(sqrt(bb(x,y,z)+eps**2) - (ab(x,y,z)+eps**2)/sqrt(aa(x,y,z)+eps**2)) \
 +  y    *(sqrt(aa(x,y,z)+eps**2) - (ab(x,y,z)+eps**2)/sqrt(bb(x,y,z)+eps**2)) \
) / d(x,y,z,eps)
wsz(x,y,z,eps) = \
(   z    *(sqrt(bb(x,y,z)+eps**2) - (ab(x,y,z)+eps**2)/sqrt(aa(x,y,z)+eps**2)) \
 +  z    *(sqrt(aa(x,y,z)+eps**2) - (ab(x,y,z)+eps**2)/sqrt(bb(x,y,z)+eps**2)) \
) / d(x,y,z,eps)
